...
import { Page, PageAttributes, PageManager } from '../sessions/PageManager';
import {
    AppMonitorDetails,
    UserDetails,
    RumEvent
...
export class EventCache {
    ...
    constructor(
        ...
        pluginManager.initEventCache(this);
    ...
    public recordPageView = (
        ...
        if (this.isCurrentUrlAllowed()) {
            this.pageManager.recordPageView(payload, interactionStart);
        }
    };
    ...
    /**
     * Returns the current page if it exists
     */
