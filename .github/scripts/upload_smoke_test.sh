...
aws s3api put-object --bucket $bucket --key "npm/es/$version/loader-npm-rum-w3c-format-enabled.js" --body smoke/smoke-test-application-NPM-ES/build/dev/loader-npm-rum-w3c-format-enabled.js --content-type application/x-javascript
...
aws s3api put-object --bucket $bucket --key "npm/cjs/$version/loader-npm-rum-w3c-format-enabled.js" --body smoke/smoke-test-application-NPM-CJS/build/dev/loader-npm-rum-w3c-format-enabled.js --content-type application/x-javascript