...
aws s3api put-object --bucket $bucket --key "npm/es/$version/loader-npm-rum-w3c-format-enabled.js" --body smoke/smoke-test-application-NPM-ES/build/dev/loader_npm_rum_w3c_format_enabled_tmp.js --content-type application/x-javascript
...
aws s3api put-object --bucket $bucket --key "npm/cjs/$version/loader-npm-rum-w3c-format-enabled.js" --body smoke/smoke-test-application-NPM-CJS/build/dev/loader_npm_rum_w3c_format_enabled_tmp.js --content-type application/x-javascript