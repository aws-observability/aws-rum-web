...
| registerDomEvents | Array | `cwr('registerDomEvents', [{ event: 'click', cssLocator: '[label="label1"]' }]);` | Update DOM plugin to register (additional) DOM events. Please refer to the [Interaction Documentation](https://github.com/aws-observability/aws-rum-web/blob/main/docs/cdn_installation.md#interaction) for information regarding the array parameter.
