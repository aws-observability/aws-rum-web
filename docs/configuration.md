...
| eventPluginsToLoad | [Plugin](examples.md#Recordcustomeventsusingaplugin)[] | `[]` | The set of custom plugins to load. See [usage examples](examples.md#Recordcustomeventsusingaplugin). |
